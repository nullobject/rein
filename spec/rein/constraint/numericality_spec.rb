...
RSpec.describe Rein::Constraint::Numericality do
  ...
  describe "#add_numericality_constraint" do
    context "greater_than" do
      it "adds a constraint" do
        expect(adapter).to receive(:execute).with("ALTER TABLE books ADD CONSTRAINT books_published_month CHECK (published_month > 1)")
    ...
    context "greater_than if" do
      it "adds a constraint" do
        expect(adapter).to receive(:execute).with("ALTER TABLE books ADD CONSTRAINT books_published_month CHECK (NOT (status = 'published') OR (published_month > 1))")
    ...
    context "greater_than_or_equal_to" do
      it "adds a constraint" do
        expect(adapter).to receive(:execute).with("ALTER TABLE books ADD CONSTRAINT books_published_month CHECK (published_month >= 2)")
    ...
    context "equal_to" do
      it "adds a constraint" do
        expect(adapter).to receive(:execute).with("ALTER TABLE books ADD CONSTRAINT books_published_month CHECK (published_month = 3)")
    ...
    context "not_equal_to" do
      it "adds a constraint" do
        expect(adapter).to receive(:execute).with("ALTER TABLE books ADD CONSTRAINT books_published_month CHECK (published_month != 0)")
    ...
    context "less_than" do
      it "adds a constraint" do
        expect(adapter).to receive(:execute).with("ALTER TABLE books ADD CONSTRAINT books_published_month CHECK (published_month < 4)")
    ...
    context "less_than_or_equal_to" do
      it "adds a constraint" do
        expect(adapter).to receive(:execute).with("ALTER TABLE books ADD CONSTRAINT books_published_month CHECK (published_month <= 5)")
    ...
    context "greater_than_or_equal_to and less_than_or_equal_to" do
      it "adds a constraint" do
        expect(adapter).to receive(:execute).with("ALTER TABLE books ADD CONSTRAINT books_published_month CHECK (published_month >= 5 AND published_month <= 6)")
  ...
  describe "#remove_numericality_constraint" do
    it "removes a constraint" do
      expect(subject).to receive(:execute).with("ALTER TABLE books DROP CONSTRAINT books_published_month")
